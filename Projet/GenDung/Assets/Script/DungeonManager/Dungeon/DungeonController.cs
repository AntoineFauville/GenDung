...
public class DungeonController : MonoBehaviour {
    ...
    public void StoryLoadingTime()
    {
        ...
        GameObject.Find("EnterD_Text").GetComponent<Text>().text = dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].dungeonStory;
    }
    ...
    public void GoDeeperInTheDungeon()
    {
        if (!dungeonLoader.loadOnce3)
        {
            ...
            if (!dungeonLoader.roomIsLocked)
            {
                ...
                dungeonLoader.actualIndex = dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].number;
                ...
                if (dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].number <= dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon.Count)
                    DungeonLoader.Instance.Background.transform.GetComponent<Image>().sprite = dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].room.back;
                ...
                for (int i = 0; i < GameObject.Find("DontDestroyOnLoad").GetComponent<SavingSystem>().gameData.SavedSizeOfTheTeam; i++)
                {
                    ...
                    DungeonLoader.Instance.CharacterUI.transform.localPosition = new Vector3(dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].room.playerPositions[i].x, dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].room.playerPositions[i].y, 0);
                }
                ...
                //print ("index2 " + index);
                dungeonLoader.index = dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].connectingTo;
                //print ("index3 " + index);
    ...
    public void loadDoor()
    {
        if (!dungeonLoader.loadOnceDoor)
        {
            ...
            DungeonLoader.Instance.Doorinstantiated.transform.localPosition = new Vector3(dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].room.doorList[0].coordinate.x, dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].room.doorList[0].coordinate.y, 0);

            //assigne les scripts que la porte a lorsqu'on clique dessus en fonction de son emplacement dans le donjon
            if (dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].doorType.ToString() == "LastDoor")
            {
    ...
    public void GetRoomType()
    {
        ...
        if (dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].number <= dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon.Count)
            dungeonLoader.roomType = dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].roomType.ToString();
        ...
        if (dungeonLoader.roomType == "chest")
        {
            ...
            if (!dungeonLoader.isUIinstantiated)
            {
                ...
                GameObject.Find("GoldUIDispatcherChest").GetComponent<Text>().text = dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].chestsList[0].GoldInTheChest.ToString();
        ...
        if (dungeonLoader.roomType == "fight")
        {
            ...
            for (int i = 0; i < dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].enemies; i++)
            {
                GameObject enemyUI;
                ...
                enemyUI.transform.GetChild(0).transform.GetChild(0).GetComponent<Image>().sprite = dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].enemiesList[i].enemyIcon;
            }
        ...
        if (dungeonLoader.roomType == "boss")
        {
            ...
            bossUI.transform.GetChild(0).GetComponent<Image>().sprite = dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].bossList[0].bossIcon;
            ...
            for (int i = 0; i < dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].enemies; i++)
            {
                ...
                enemyBossUI.transform.GetChild(0).GetComponent<Image>().sprite = dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index].enemiesList[i].enemyIcon;
            }
        }
    }
    ...
    public void AddRewards()
    {
        ...
        this.transform.GetComponent<CurrencyGestion>().IncreaseMoney(dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index - 1].chestsList[0].GoldInTheChest);
        DungeonLoader.Instance.LogT.AddLogLine("You have gain " + dungeonLoader.roomListDungeon[dungeonLoader.dungeonIndex].RoomOfTheDungeon[dungeonLoader.index - 1].chestsList[0].GoldInTheChest + " gold !");
